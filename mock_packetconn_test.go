...
//
//	mockgen -typed -package quic -self_package github.com/gandalfast/quic-go-h3 -self_package github.com/gandalfast/quic-go-h3 -destination mock_packetconn_test.go net PacketConn
//
